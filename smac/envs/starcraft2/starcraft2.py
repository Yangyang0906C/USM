...
class StarCraft2Env(MultiAgentEnv):
    ...
    def _launch(self):
        ...
        self.min_play_area_x = map_play_area_min.x
        self.min_play_area_y = map_play_area_min.y
    ...
    def get_state(self):
        ...
        for al_id, al_unit in self.agents.items():
            if al_unit.health > 0:
                ...
                ally_state[al_id, 2] = (
                    x - self.min_play_area_x
                ) / self.max_distance_x  # relative X
                ally_state[al_id, 3] = (
                    y - self.min_play_area_y
                ) / self.max_distance_y  # relative Y
